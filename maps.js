...
function usePointFromPostcode(postcode, callbackFunction) {
	...
	function getBusTimetable(buststop){
		...
		var bustimeurl = 'http://transportapi.com/v3/uk/bus/stop/'+buststop+'/'+date+'/'+time+'/timetable.json?group=no&api_key=e2c96777c715a5d317c9d2016fdf5284&app_id=b4d09e5d&callback=?'
